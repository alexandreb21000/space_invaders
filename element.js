...
var form1 = new Sprite ( 'form1.png', 450, 50);
var form2 = new Sprite ( 'form2.png', 550, 50);
var form3 = new Sprite ( 'form3.png', 650, 50);
var form4 = new Sprite ( 'form4.png', 750, 50);
var form5 = new Sprite ( 'form1.png', 850, 50);
var form6 = new Sprite ( 'form2.png', 950, 50);
var form7 = new Sprite ( 'form4.png', 1050,50);

var form8 = new Sprite ( 'form1.png', 300, 150);
var form9 = new Sprite ( 'form2.png', 400, 150);
var form10 = new Sprite ( 'form3.png', 500, 150);
var form11 = new Sprite ( 'form4.png', 600, 150);
var form12= new Sprite ( 'form1.png', 700, 150);
var form13 = new Sprite ( 'form2.png', 800, 150);
var form14 = new Sprite ( 'form4.png', 900, 150);

var form15 = new Sprite ( 'form1.png', 450, 250);
var form16 = new Sprite ( 'form2.png', 550, 250);
var form17 = new Sprite ( 'form3.png', 650, 250);
var form18 = new Sprite ( 'form4.png', 750, 250);
var form19 = new Sprite ( 'form1.png', 850, 250);
var form20 = new Sprite ( 'form2.png', 950, 250);
var form21 = new Sprite ( 'form4.png', 1050, 250);
...
document.onkeydown = function( event ) {
    if ( event.keyCode == 37) {                         //déplacement vers la gauche 
        vaisseau.left -= 10;
        setTimeout (shootFromEnnemy1, 3000);

    } else if ( event.keyCode == 39 ) {                 //déplacement vers la droite
        vaisseau.left += 10;
        setTimeout (shootFromEnnemy2, 1000); 
    }
...
function shootFromEnnemy2()  {
    if ( missile2.display == "none" ) {
        for(var i=1; i<=21; i++ ) {
            var form = window["form"+i];}
    missile2.display = "block";
    missile2.left = form15.left + (form15._node.width - missile2._node.width) / 2 ;
    missile2.top = form15.top;
    missile2.startAnimation( moveMissile2, 20 );
    }
}   
...
function collisionVaisseauForm (form) { // function collision : Si les "form" touchent le vaisseau = collision
    for(var i=1; i<=21; i++ ) {
        var form = window["form"+i];
...
function moveFormToLeft ( form ) {
    ...
    collisionVaisseauForm(); // Référence à la fonction collision plus haut
}
...
var total_form = form.length; 
var xform = Math.floor(Math.random() * Math.floor(total_form - 1));

function setTirRandow(){
    xform = Math.floor(Math.random() * Math.floor(total_form - 1)); {
        missile2.startAnimation(); 
    }
}